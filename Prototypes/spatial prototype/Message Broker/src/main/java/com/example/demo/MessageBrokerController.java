...
public class MessageBrokerController {
    ...
    Subscription subscribe(@RequestBody SubscriptionWrapper subscription){
        return messageBrokerService.addSubscription(subscription.getSubscription());
    }
    ...
    void unsubscribe(@RequestBody SubscriptionWrapper subscription){
        messageBrokerService.unsubscribe(subscription.getSubscription());
    }
